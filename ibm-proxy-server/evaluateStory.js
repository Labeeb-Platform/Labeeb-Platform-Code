...
(async () => {
  ...
  const storyText = 'كان هناك طفل صغير يُدعى "سامي" يريد أن يلعب مع أصدقائه بدلاً من الذهاب إلى المدرسة. فكر سامي وقال لوالدته أنه مريض ولا يستطيع الذهاب إلى المدرسة. بقي سامي في المنزل ولعب طوال اليوم. ولم يكتشف أحد أنه كان يكذب.'; // Replace with actual story text
